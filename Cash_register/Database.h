...
public:
     ...
     {
         if(add_delete==true){this->listOfProducts[code].numOfProducts--;}
         else if(add_delete==false){this->listOfProducts[code].numOfProducts++;}
     }
};
...
{
    dataBaseProducts.listOfProducts[0].exist=1;
    dataBaseProducts.dataBaseProducts.listOfProducts[0].nameProduct="Fridge";
    dataBaseProducts.listOfProducts[0].numOfProducts=3;
    dataBaseProducts.listOfProducts[0].price=10000;

    dataBaseProducts.listOfProducts[1].exist=1;
    dataBaseProducts.dataBaseProducts.listOfProducts[1].nameProduct="Microwave LG";
    dataBaseProducts.listOfProducts[1].numOfProducts=2;
    dataBaseProducts.listOfProducts[1].price=4000;

    dataBaseProducts.listOfProducts[2].exist=0;
    dataBaseProducts.dataBaseProducts.listOfProducts[2].nameProduct="NoteBook HP";
    dataBaseProducts.listOfProducts[2].numOfProducts=0;
    dataBaseProducts.listOfProducts[2].price=15000;

    dataBaseProducts.listOfProducts[3].exist=1;
    dataBaseProducts.dataBaseProducts.listOfProducts[3].nameProduct="Microwave Lenovo";
    dataBaseProducts.listOfProducts[3].numOfProducts=2;
    dataBaseProducts.listOfProducts[3].price=3500;

    dataBaseProducts.listOfProducts[4].exist=1;
    dataBaseProducts.dataBaseProducts.listOfProducts[4].nameProduct="Coffee maker";
    dataBaseProducts.listOfProducts[4].numOfProducts=4;
    dataBaseProducts.listOfProducts[4].price=1000;

    dataBaseProducts.listOfProducts[5].exist=1;
    dataBaseProducts.dataBaseProducts.listOfProducts[5].nameProduct="Stove";
